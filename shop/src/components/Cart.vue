   ...
   <div class="card shopping-cart">
                    ...
                    <div class="row" v-for="p in filtered" v-bind:key="p.product.nazwa">
                        ...
                        <div class="col-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
                            <div class="col-3 col-sm-3 col-md-6 text-md-right" style="padding-top: 11px">
                                <h6><strong>{{p.product.cena_jednostkowa.toFixed(2)}} <span class="text-muted">x</span></strong></h6>
                            </div>
            ...
            <div class="card-footer">
                ...
                <div class="pull-right" style="margin: 10px">
                    <router-link to="/checkout" class="btn btn-success pull-right">Checkout</router-link>
